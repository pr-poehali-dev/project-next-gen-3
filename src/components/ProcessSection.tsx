...
import { Lightbulb, Sparkles, Heart, ArrowRight } from "lucide-react"
...
const steps = [
  {
    ...
    description:
      "Выбираете понравившуюся услугу и удобное время на сайте или по телефону. Наш администратор подберёт мастера под ваши пожелания.",
    number: "01",
  },
  {
    icon: Sparkles,
    ...
    description:
      "Вас встретят в уютной студии в центре города. Мастер уточнит ваши пожелания по форме, длине и дизайну, выберете оттенок из каталога.",
    number: "02",
  },
  {
    icon: Heart,
    ...
    description:
      "Уходите с идеальным маникюром или педикюром. Мы дадим рекомендации по уходу, а запись на следующий визит займёт минуту.",
    number: "03",
  },
]
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 text-balance">
            От <span className="text-primary">записи</span> до <span className="text-primary">восторга</span>
          </h2>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-pretty leading-relaxed">
            Три простых шага — и ваши ногти станут произведением искусства.
          </p>
        </div>
